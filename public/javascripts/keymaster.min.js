(function (global) {
  ...
  function dispatch(event) {
    ...
    if (key in _mods) {
      _mods[key] = !0;
      for (k in _MODIFIERS) if (_MODIFIERS[k] == key) assignKey[k] = !0;
      return;
    }
    ...
    for (i = 0; i < _handlers[key].length; i++) {
      ...
      if (handler.scope == scope || handler.scope == 'all') {
        ...
        if (
          ...
          if (handler.method(event, handler) === !1) {
            if (event.preventDefault) event.preventDefault();
            else event.returnValue = !1;
            if (event.stopPropagation) event.stopPropagation();
            if (event.cancelBubble) event.cancelBubble = !0;
          }
        }
      }
    }
  ...
  function clearModifier(event) {
    ...
    if (key in _mods) {
      _mods[key] = !1;
      for (k in _MODIFIERS) if (_MODIFIERS[k] == key) assignKey[k] = !1;
    }
  }
  ...
  function addEvent(object, event, method) {
    if (object.addEventListener) object.addEventListener(event, method, !1);
