  ...
  function e(s, e) {
    ...
    (this.translateZ = this.options.HWCompositing && h.hasPerspective ? ' translateZ(0)' : ''),
      ...
      (this.options.scrollY =
        'vertical' == this.options.eventPassthrough ? !1 : this.options.scrollY),
    ...
    if (
      ...
      this.options.interactive &&
        (this.options.disableTouch ||
          (h.addEvent(this.indicator, 'touchstart', this), h.addEvent(t, 'touchend', this)),
        ...
        this.options.disableMouse ||
          (h.addEvent(this.indicator, 'mousedown', this), h.addEvent(t, 'mouseup', this))),
      this.options.fade)
    ) {
      ...
      (o.getTime =
        ...
        (o.momentum = function (t, i, e, o, n, r) {
          ...
          return (
            ...
            (a = c / r),
            o > h
              ? ((h = n ? o - (n / 2.5) * (c / 8) : o), (l = s.abs(h - t)), (a = l / c))
              : h > 0 && ((h = n ? (n / 2.5) * (c / 8) : 0), (l = s.abs(t) + h), (a = l / c)),
          ...
          elastic: {
            ...
            fn: function (t) {
              ...
              return 0 === t
                ...
                : 1 == t
                ? 1
                : e * s.pow(2, -10 * t) * s.sin(((t - i / 4) * (2 * s.PI)) / i) + 1;
            },
          },
        }),
        (o.tap = function (t, s) {
          ...
          if (
            ...
            (this.currentPage = d),
              (c =
                ...
                s.max(s.max(s.min(s.abs(n - d.x), 1e3), s.min(s.abs(r - d.y), 1e3)), 300)),
              (n = d.x),
              (r = d.y),
              (this.directionX = 0),
              (this.directionY = 0),
