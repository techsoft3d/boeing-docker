...
!(function (i) {
  ...
  function i(i, t) {
    ...
    i.data('minicolors-initialized') ||
      ...
      (n = 'rgb' === t.format ? (t.opacity ? '25' : '20') : t.keywords ? '11' : '7'),
      i
  ...
  function s(i, t, o) {
    ...
    t.originalEvent.changedTouches &&
      ...
      i.parent().is('.minicolors-slider-wheel') &&
        ...
        (m = Math.atan2(p, u)),
        0 > m && (m += 2 * Math.PI),
        g > 75 && ((g = 75), (l = 75 - 75 * Math.cos(m)), (h = 75 - 75 * Math.sin(m))),
        (l = Math.round(l)),
        (h = Math.round(h))),
      i.is('.minicolors-grid')
        ? r.stop(!0).animate({ top: h + 'px', left: l + 'px' }, d, s.animationEasing, function () {
            n(a, i);
          })
      ...
      switch (v.control) {
        case 'wheel':
          (r = y.width() / 2 - z.x),
            ...
            (d = Math.atan2(c, r)),
            0 > d && (d += 2 * Math.PI),
            l > 75 && ((l = 75), (z.x = 69 - 75 * Math.cos(d)), (z.y = 69 - 75 * Math.sin(d))),
            (s = g(l / 0.75, 0, 100)),
        ...
        case 'saturation':
          (a = g(parseInt(z.x * (360 / y.width()), 10), 0, 360)),
            ...
            (u = w({ h: a, s: s, b: n })),
            C.css('backgroundColor', w({ h: a, s: 100, b: n })),
  ...
  function r(i, t) {
    ...
    switch (
      ...
      x.opacity &&
        ...
        T.css('top', v + 'px')),
      'transparent' === i.val().toLowerCase() && I.find('span').css('opacity', 0),
      ...
      case 'wheel':
        (y = g(Math.ceil(0.75 * a.s), 0, S.height() / 2)),
          ...
          j.css({ top: v + 'px', left: l + 'px' }),
          (v = 150 - a.b / (100 / S.height())),
          '' === o && (v = 0),
          D.css('top', v + 'px'),
          z.css('backgroundColor', w({ h: a.h, s: a.s, b: 100 }));
        break;
      case 'saturation':
        (l = g((5 * a.h) / 12, 0, 150)),
          (v = g(S.height() - Math.ceil(a.b / (100 / S.height())), 0, S.height())),
          j.css({ top: v + 'px', left: l + 'px' }),
          (v = g(z.height() - a.s * (z.height() / 100), 0, z.height())),
          D.css('top', v + 'px'),
          z.css('backgroundColor', w({ h: a.h, s: 100, b: a.b })),
          k.find('.minicolors-grid-inner').css('opacity', a.s / 100);
        break;
      case 'brightness':
        (l = g((5 * a.h) / 12, 0, 150)),
          (v = g(S.height() - Math.ceil(a.s / (100 / S.height())), 0, S.height())),
          j.css({ top: v + 'px', left: l + 'px' }),
      ...
      default:
        (l = g(Math.ceil(a.s / (100 / S.width())), 0, S.width())),
          ...
          D.css('top', v + 'px'),
          S.css('backgroundColor', w({ h: a.h, s: 100, b: 100 }));
    }
  ...
  function u(i, t) {
    ...
    return (
      ...
      t
        ? { r: a[0], g: a[1], b: a[2], a: a[3] ? a[3] : null }
        ...
        switch (s) {
          ...
          case 'value':
            return void 0 === n
              ...
              : ($(this).each(function () {
                  'object' == typeof n
                    ? (n.opacity && $(this).attr('data-opacity', g(n.opacity, 0, 1)),
      ...
      .on('blur.minicolors', '.minicolors-input', function () {
        ...
        i.data('minicolors-initialized') &&
          ...
          '' !== i.val() && $.inArray(i.val().toLowerCase(), o) > -1
            ? (r = i.val())
            : (m(i.val()) ? (s = u(i.val(), !0)) : ((a = d(i.val(), !0)), (s = a ? k(a) : null)),
              (r =
                null === s
                  ? t.defaultValue
                  : 'rgb' === t.format
                  ? u(
                      t.opacity
                        ? 'rgba(' + s.r + ',' + s.g + ',' + s.b + ',' + i.attr('data-opacity') + ')'
                        : 'rgb(' + s.r + ',' + s.g + ',' + s.b + ')'
                    )
                  : y(s))),
          (n = t.opacity ? i.attr('data-opacity') : 1),
          'transparent' === r.toLowerCase() && (n = 0),
          i.closest('.minicolors').find('.minicolors-swatch > span').css('opacity', n),
          i.val(r),
